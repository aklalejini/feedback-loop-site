...
// Clearly-labeled "Sample — " prefix on a sample batch's name so the maker can
// recognise and dismiss it. The concrete sample variants live in lib/samples.ts;
// only the prefix is exported here because storage / display references it.
